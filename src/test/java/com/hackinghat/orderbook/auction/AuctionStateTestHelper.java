...
public class AuctionStateTestHelper extends AbstractComponent
{
    ...
    long addLimit(final OrderSide side, final int quantity, final Double limit)
    {
    ...
    {
        addLimit(OrderSide.BUY, 10000, 105.5);
        addLimit(OrderSide.BUY, 5600, 104.5);
        addLimit(OrderSide.BUY, 200, 104.0);
        addMarket(OrderSide.SELL, 2500);
        addLimit(OrderSide.SELL, 6900, 103.0);
        addLimit(OrderSide.SELL, 1000, 104.5);
        addLimit(OrderSide.SELL, 200, 106.0);
    ...
    public AuctionState makeState2()
    {
        ...
        addMarket(OrderSide.SELL, 2500);
        addLimit(OrderSide.SELL, 6900, 103.0);
        addLimit(OrderSide.SELL, 1000, 104.0);
        addLimit(OrderSide.SELL, 200, 106.0);
        return  new AuctionState(timeMachine.toSimulationTime(), referenceLevel, instrument, bidBook, offerBook);
    }
    ...
    {
        addLimit(OrderSide.BUY, 10000, 105.5);
        addLimit(OrderSide.BUY, 5600, 105.0);
        addLimit(OrderSide.BUY, 1000, 104.0);
        addMarket(OrderSide.SELL, 2500);
        addLimit(OrderSide.SELL, 6900, 103.0);
        addLimit(OrderSide.SELL, 1000, 104.0);
        addLimit(OrderSide.SELL, 200, 106.0);
    ...
    {
        addLimit(OrderSide.BUY, 6000, 105.0);
        addLimit(OrderSide.BUY, 1000, 104.5);
        addLimit(OrderSide.BUY, 1000, 104.0);
        addLimit(OrderSide.BUY, 6000, 103.5);

        addLimit(OrderSide.SELL, 6000, 103.0);
        addLimit(OrderSide.SELL, 1000, 104.0);
        addLimit(OrderSide.SELL, 1000, 104.5);
        addLimit(OrderSide.SELL, 6000, 105.5);
        return  new AuctionState(timeMachine.toSimulationTime(), referenceLevel, instrument, bidBook, offerBook);
    }
}
