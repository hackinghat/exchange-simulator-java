...
public class OrderTest
{
     ...
     */
    public static Order limitOrder(Long id, OrderSide side, Instrument inst, Number limit, int quantity, Agent nullAgent, TimeMachine timeMachine, boolean accepted)
    {
    ...
    public void testSimpleResets()
    {
        ...
        order.fillQuantity(50, instrument.getLevel(100.5), timeMachine.toSimulationTime());
        checkStateAndVersion(order, OrderState.PARTIALLY_FILLED, 3);
        order.fillQuantity(950, instrument.getLevel(100.1), timeMachine.toSimulationTime());
    ...
    public void testLevelPriority()
    {
        ...
        Order order1 = new Order("C1", OrderSide.BUY, instrument, instrument.getLevel(100.0), 1000, nullAgent, timeMachine);
        ...
        Order order3 = new Order("C3", OrderSide.BUY, instrument, instrument.getLevel(110.0), 1000, nullAgent, timeMachine);
    ...
    {
        final BigDecimal px1 = new BigDecimal(100.005);
        ...
        assertTrue(order1.getLevel().equals(instrument.getLevel(px1)));
        final BigDecimal px2 = new BigDecimal(100.010001);
        ...
        assertTrue(order2.getLevel().equals(instrument.getLevel(px2)));
    }
    ...
    public void testCancel()
    {
        ...
        order.fillQuantity(20, instrument.getLevel(100.0), timeMachine.toSimulationTime());
        checkStateAndVersion(order, OrderState.CANCELLED, 4);
