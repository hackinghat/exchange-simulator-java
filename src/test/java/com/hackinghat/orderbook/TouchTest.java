...
public class TouchTest
{
    ...
    public void testTicksBetweenChoice() throws InvalidMarketStateException
    {
        ...
        Level level = makeLevel(100.1, vod);
    ...
    public void testTicksBetweenBack() throws InvalidMarketStateException
    {
        ...
        Touch t = new Touch(timeMachine.toSimulationTime(), MarketState.CONTINUOUS, new OrderInterest(OrderSide.BUY, makeLevel(100.1, vod), 200, 1000),
                new OrderInterest(OrderSide.SELL, makeLevel(99.1, vod), 100, 1000));
