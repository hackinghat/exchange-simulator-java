...
public class PriorityOrderTest {
    ...
    public void testNew() {
        ...
        final OrderLimitQueue limitLimit = new OrderLimitQueue(LevelTest.makeLevel(100.0f, VOD), OrderSide.BUY);
        final PriorityOrders priorityOrders = new PriorityOrders(VOD, VOD.getMarket(), Arrays.asList(marketLimit, limitLimit));
    ...
    public void testPriorityOrders() {
        ...
        final OrderLimitQueue L100 = new OrderLimitQueue(LevelTest.makeLevel(100.0f, VOD), OrderSide.BUY);
        L100.add(OrderTest.limitOrder(1L, OrderSide.BUY, VOD, 100.0f, 100, nullAgent, timeMachine, true));
        final OrderLimitQueue L101 = new OrderLimitQueue(LevelTest.makeLevel(101.0f, VOD), OrderSide.BUY);
        L101.add(OrderTest.limitOrder(1L, OrderSide.BUY, VOD, 101.0f, 200, nullAgent, timeMachine, true));
